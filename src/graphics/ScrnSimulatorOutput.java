...
public class ScrnSimulatorOutput extends JPanel {
    ...
    public ScrnSimulatorOutput(MainEngine mainEngine, Branding branding,
    ...
    private JPanel buildAlgoPanel(AlgoResult r) {
        ...
        header.add(makeMonoLabel("Reference String: " + joinInts(r.referenceString),
                                branding.jetBrainsRMedium, 12));
        header.add(Box.createVerticalStrut(2));
        header.add(makeMonoLabel("Page Frame: "        + r.pageFrameCount,
                                branding.jetBrainsRMedium, 12));
        header.add(Box.createVerticalStrut(2));
        header.add(makeMonoLabel("Total Page Fault: "  + r.totalPageFaults,
                                branding.jetBrainsRMedium, 12));
        ...
        JScrollPane hScroll = new JScrollPane(grid,
